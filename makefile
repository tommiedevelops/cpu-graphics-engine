...
LDFLAGS = -L/opt/homebrew/lib -lSDL2 -lm -Iinclude -I_core/math -I_core/renderer -I_core/scene -I_core/window -I_app/ -I_core -I_core/third_party -I_core/shader
DEBUGFLAGS = -fsanitize=address
SRC_FILES := _core/math/*.c _core/renderer/*.c _core/window/*.c _core/*.c _core/scene/*.c _app/*.c _core/shader/*.c

...
LDFLAGS = -L/opt/homebrew/lib -lSDL2 -lm -Iinclude -Icore/math -Icore/renderer -Iapp/asset_builders -Icore/platform -Iapp/ -Icore -Icore/third_party 
DEBUGFLAGS = -fsanitize=address -g
SRC_FILES := core/math/*.c core/renderer/*.c core/platform/*.c app/asset_builders/*.c app/*.c 

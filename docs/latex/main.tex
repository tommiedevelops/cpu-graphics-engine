...
\begin{tikzpicture}
	...
	% near plane
	\filldraw[fill=red!20, draw=blue!50!black, opacity=0.7]
		(nearBotLeft) -- (nearTopLeft) -- (nearTopRight) -- (nearBotRight) -- cycle;
		
	% left plane
	\filldraw[fill=green!20, draw=blue!50!black, opacity=0.7]
		(nearBotLeft) -- (nearTopLeft) -- (farTopLeft) -- (farBotLeft) -- cycle;
	
	% bottom plane
	\filldraw[fill=blue!20, draw=blue!50!black, opacity=0.7]
